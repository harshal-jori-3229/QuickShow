  ...
  return (
    <div className='flex flex-col items-start justify-center gap-4 px-6 md:px-16 1g:px-36 bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
        ...
        <p className='max-w-md text-gray-300'>
            A world of wonder and excitement awaits! Experience the extraordinary as imagination meets reality. From breathtaking adventures to awe-inspiring creations, every moment is crafted to leave you amazed.
        </p>
